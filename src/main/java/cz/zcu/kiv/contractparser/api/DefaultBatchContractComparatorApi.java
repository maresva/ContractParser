...
/**
 * Provides methods used to compare JavaFiles in batch similar to DefaultContractComparatorApi. Methods are focused on batch
 * operations meaning data are not stored in memory but are exported right away.
 *
 * @author Vaclav Mares
 */
public class DefaultBatchContractComparatorApi implements BatchContractComparatorApi{

    /** Instance of JavaFolderComparator which is used to call compare methods */
    private JavaFolderComparator javaFolderComparator;


    public DefaultBatchContractComparatorApi() {
     ...
     */
    public JavaFolderCompareReport compareJavaFoldersAndExportToJson(File thisFolder, File otherFolder, boolean reportEqual,
